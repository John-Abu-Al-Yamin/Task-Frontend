    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0f0c] via-[#0f1611] to-[#0a0f0c] flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-5xl font-bold text-white mb-4 tracking-tight">Parking System</h1>
          <p className="text-xl text-[#9eb7a8] max-w-2xl mx-auto">
            Complete parking reservation and management system with real-time updates
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="bg-[#0a0f0c]/80 border-[#29382f] backdrop-blur-sm hover:border-[#38e07b]/50 transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Gate Check-in</h3>
              <p className="text-[#9eb7a8] text-sm">Visitor and subscriber check-in with real-time zone availability</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#0a0f0c]/80 border-[#29382f] backdrop-blur-sm hover:border-[#38e07b]/50 transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-[#9eb7a8] text-sm">Employee portal for ticket checkout and payment processing</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#0a0f0c]/80 border-[#29382f] backdrop-blur-sm hover:border-[#38e07b]/50 transition-all duration-300">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-[#9eb7a8] text-sm">Complete system management and reporting dashboard</p>
            </CardContent>
          </Card>
        </div>
